         ...
         <tr>
            <td>
			   ...
			   <br><br><br><table width="497" border="1">
                 <tr>
                   <td colspan="6" align="center" valign="middle"><div align="center"><span class="Estilo16">Ingresar Datos Personales Participoante </span></div></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   ...
                   <td colspan="3" class="Estilo12"><span class="Estilo3">
                     <input name="CampoEdad" onKeyPress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" type="text" size="4" maxlength="2" />
                   </span></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   <td align="right" valign="middle" class="Estilo7">Foto</td>
                   <td colspan="5"><input name="CampoFoto" type=file class="Estilo12" value="Examinar" size="45" maxlength="35" /></td>
                 </tr>
           </table>			   </td>
         </tr>
         <tr>
            <td><p align="center">
              <input name="Ingresar" type="submit" class="boton" value="Ingresar Informacion" /><br><input name="Regresar" type="submit" class="boton" id="Regresar" value="Regresar">
                </p>
