<?php
   ...
   if (isset($_POST['Regresar'])){      
	  echo "<script language=\"JavaScript\" type=\"text/JavaScript\">";
	  echo "window.location.href= '../Buzon/BuzonAdministrador.php'";	   
	  echo "</script>";	  
   }
?> 
<html>
...
<table width="311" height="299" border="8" align="center">
  <tr>
    <td height="25" align="center" valign="bottom" bordercolor="#999999"><div align="right" class="Estilo11"><img src="../../../images/LOGOTRANS.jpg" width="52" height="41" align="left">Bienvenido <span class="Estilo23">WEBMASTER</span></div></td>
  </tr>
  <tr>
