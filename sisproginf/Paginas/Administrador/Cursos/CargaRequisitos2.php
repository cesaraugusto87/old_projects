<?php
   ...
   if($_POST['Ingresar']){
	  ...
	  if (($req != "")and($id != 0)){
	     ...
	     if($filas_r > 0){
	        echo "<script>alert('Requisito Ingresado con Exito ".$id."...');</script>"; 
	     ...
	     echo "<script>alert('El Campo no Puede estar Vacio o Debe Indicar A que curso Esta Relacionado el Requisito ...".$id."');</script>"; 
	     echo "<script language=\"JavaScript\" type=\"text/JavaScript\">";
	     echo "window.location.href= 'CargaRequisitos2.php'";	   
	     echo "</script>";
	  }
   }
   if($_POST['Ingresar2']){      
...
<body>
   ...
   <table width="566" border="1" align="center">
     ...
     <tr>
       <td><input type="hidden" name="CampoId" value="<?php echo $id;?>"></td>
     </tr>
     <tr>
