...
<body>
	<form name="form1" method="post" action="../Reportes/ListadoParticipantesPorCurso.php">
  ...
  <tr>
    <td><table width="185" height="150" border="0" align="center" cellpadding="0" cellspacing="0" class="Estilo4">
        ...
        <th height="25" valign="middle"><div align="center">
          <?php 
		     if($cursos == ""){
                  ...
                  $conex = Conectarse(); 							   
               	  $sql="SELECT * FROM ofertacurso WHERE (Status=1) order by FechaIni";
			   	  $resultado_set = mysql_query ($sql, $conex);
			      $ifilas = mysql_num_rows ($resultado_set);
		   	   ?>
          <select name="CampoCurso" class="Estilo12"  maxlength="50" onChange="MM_jumpMenu('parent',this,0)">
            ...
            <?php
				     ...
				     ?>
            <option value="../Reportes/IndicaCursoParaListado.php?Id=<?php echo $id; ?>"><?php echo $nombrecurso; }?></option>
          </select>
		  <? }else{ 
		    //Libreria que permite conectarse a la base de datos 
                  include('../../../funciones/conexion.php');
      ...
      <tr>
        <th height="25" valign="middle"><div align="center">
		   <?php
		         $sqloferta="SELECT * FROM ofertacurso where (IdCursos = '".$cursos."') order by Secuencia";
