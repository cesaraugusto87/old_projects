...
class PDF extends FPDF{
   ...
   function Header(){
	  ...
	  $this->Cell(70);
	  //Título
	  $this->Text(70,36,'Listado de Cartuchos En Alta Vista.');
...
$pdf->SetFont('Times','',10);  
   ...
   $sql_oferta = "Select operador,reporte_secuencia,id_mod,idinicializacion,observaciones,id_ubicacion,numero_cartuchos,num_cartucho2,id_nomenclatura,fecha_ini,fecha_fin,fecha_exp,idnomenclatura,estante,id_frecuencia,cuerpo,tramo,boveda,gaveta,consecutivo from cartuchos, id_sistema where id_nomenclatura = idnomenclatura And id_ubicacion = 'AV' order by id_mod,fecha_ini,estante,cuerpo,tramo,boveda,gaveta"; 	
