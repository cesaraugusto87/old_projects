...
-->
   ...
   <body>
   <form action="BuscarXNomEspecifica.php" method="post" name="formulario">
      <p>&nbsp;</p>
      <table width="311" height="299" border="8" align="center">
        <tr>
          <td height="25"><div align="center"><span class="Estilo11">Buscar Por Nomenclatura</span></div></td>
        </tr>
        <tr>
          ...
          <table width="163" border="5" align="center">
            <tr>
              <td><table width="163" height="100" border="0" align="center" cellpadding="0" cellspacing="0" class="Estilo4">
                  <!--DWLayoutTable-->
                  <tr>
                    <th height="25" valign="center"><div align="center" class="boton">Indique Nomenclatura</div></th>
                  </tr>
                  <tr>
                    <th height="25" valign="center"><div align="center">
                        <input name="nomenclatura" type="text" class="entradas" id="nomenclatura" size="12" maxlength="10">
                    </div></th>
                  </tr>
                  <tr>
                    <th height="25" valign="center"><div align="center">
