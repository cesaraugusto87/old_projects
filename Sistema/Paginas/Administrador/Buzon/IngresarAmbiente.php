...
-->
   ...
   <body>
      <form name="formusuario" ENCTYPE="multipart/form-data" action="ValidarAmbiente.php" method="post">
	    <p>&nbsp;</p>
         ...
         <tr>
           <td>
			   ...
			   <br><br><br><table width="497" border="1">
                 ...
                 <tr>
                   <td width="45" align="right" valign="middle" class="Estilo7">Codigo Ambiente </td>
                   <td width="150" class="Estilo12"><input name="Cod_amb" type="text" size="25" maxlength="8" /></td>
                   <td width="35" align="right" valign="middle" class="Estilo7">Ambiente </td>
                   <td width="156" class="Estilo12"><input name="Nom_amb" onKeyPress="return validar(event)" type="text" size="20" maxlength="50" /></td>
                 </tr>
           </table>			   </td>
         </tr>
         <tr>
