...
$pdf->SetFont('Times','',10);  
   ...
   $sql = " select  * from cartuchos, id_sistema where (fecha_exp >= ".$fecha_act.") AND (idnomenclatura = id_nomenclatura) "; 
   ...
   if ($totalregistros > 0){ 
	  ...
	  do { 
         ...
         $pdf->Cell(1);
		 $pdf->SetFont('Times','',7);
	     $pdf->Cell(30,5,$row_listado['idinicializacion'],1,0,'C');
		 $pdf->Cell(10,5,$row_listado['numero_cartuchos'],1,0,'C');
		 $pdf->Cell(16,5,$row_listado['id_mod'],1,0,'C');
		 $pdf->Cell(22,5,$row_listado['fecha_ini'],1,0,'C');
		 $pdf->Cell(22,5,$row_listado['fecha_fin'],1,0,'C');
		 $pdf->Cell(20,5,$row_listado['id_ubicacion'],1,0,'C');
 		 $pdf->Cell(50,5,$row_listado['observaciones'],1,0,'C');
 		 $pdf->Cell(12,5,$row_listado['tipo'],1,0,'C');
	     $pdf->Ln();  
	     $i=$i+1;
