...
-->
   ...
   <body>
      <form name="formusuario" ENCTYPE="multipart/form-data" action="ValidarCarrera.php" method="post">
	    <p>&nbsp;</p>
         ...
         <tr>
           <td>
			   ...
			   <br><br><br><table width="497" border="1">
                 <tr>
                   <td colspan="4" align="center" valign="middle"><div align="center"><span class="Estilo16">Ingresar Carrera </span></div></td>
                 </tr>
                 <tr>
                   <td width="45" align="right" valign="middle" class="Estilo7">Codigo Carrera </td>
                   <td width="150" class="Estilo12"><input name="Cod_carrera" onKeyPress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" type="text" size="25" maxlength="8" /></td>
                   <td width="35" align="right" valign="middle" class="Estilo7">Nombre Carreras </td>
                   <td width="156" class="Estilo12"><input name="Nom_carrera" onKeyPress="return validar(event)" type="text" size="20" maxlength="50" /></td>
                 </tr>
           </table>			   </td>
         </tr>
         <tr>
