...
class Registro
{
	...
	{
		$datos = new Paciente();
		$ver = $datos->buscar_ci($registro["Cedula"])
		
		
		$FormVars["IdPaciente"]		=	$ver->mensajes["IdPaciente"];
		$FormVars["Cedula"]			=	$ver->mensajes["Cedula"];
		$FormVars["Nombre"]			=	$ver->mensajes["Nombre"];
		$FormVars["Apellido"]		=	$ver->mensajes["Apellido"];
		$FormVars["Edad"]			=	$ver->mensajes["Edad"];
	...
	public function validacionAgregar ( $registro)
	{
		...
		{
			array_push($respuesta->errores, "Es necesario agregar una observacion.");
		}
...
#####################################
	...
	public function obtenerSolicitud( $IdReporte)
	{
