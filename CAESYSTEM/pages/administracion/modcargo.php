...
<h2 class="Estilo1">Modificar cargo</h2>
<hr/>
<br>
<br>
   ...
   <tr>
    ...
    <div id="ReportDetails">
      <table width="341"  border="1" align="center" class="ReportDetails">
        <tr>
          <td width="167" class="ReportTableHeaderCell">Id Cargo: </td>
      ...
      <?php
	  $id_cargo = $_POST["campo0"];
	  $descripcion1 = $_POST["campo1"];
	 
	 	  	  
if($_POST['update']){
		  	  
	$mod="UPDATE cargo SET descripcion='$descripcion1' WHERE id_cargo='$id_cargo'";
