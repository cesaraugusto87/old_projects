...
if ($_POST['Modificar']){
	...
	$consulta="SELECT * FROM horarios WHERE id_horarios = '$id'";
...
<h2 class="Estilo1">Modificar Horario</h2>
<hr/>
<br>
<br>
   ...
   <tr>
    ...
    <div id="ReportDetails">
      <table width="341"  border="1" align="center" class="ReportDetails">
        <tr>
          <td width="167" class="ReportTableHeaderCell">Id Horario: </td>
          <td width="164" class="ReportDetailsOddDataRow"align="center">
          	<input type="text" name="campo0" id="campo0"  readonly="readonly" value="<?php echo $row[0]; ?>"/>          </td>
                ...
                <tr>
          <td width="167" class="ReportTableHeaderCell">Hora Inicio: </td>
          <td width="164" class="ReportDetailsOddDataRow"align="center">
            <input type="text" name="campo1" id="campo1" value="<?php echo $row[2]; ?>"/>          </td>
        </tr>
        <tr>
          <td class="ReportTableHeaderCell">Hora Final: </td>
      ...
      <?php
	  $id = $_POST["campo0"];
	  $hora_inicio = $_POST["campo1"];
	  $hora_fin = $_POST["campo2"];
	 	  	  
if($_POST['update']){
		  	  
	$mod="UPDATE horarios SET hora_final='$hora_fin', hora_inicio='$hora_inicio' WHERE id_horarios='$id'";
