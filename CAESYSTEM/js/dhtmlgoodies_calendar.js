...
var selectBoxHighlightColor = '#FF0000'; // '#D60808' Highlight color of select boxes
var selectBoxRolloverBgColor = '#0000FF'; // '#E2EBED' Background color on drop down lists(rollover)
var weekColor = '#FFFFFF'; // Week Color
