...
<?php
	echo "<h1>Ingresar Datos del Cliente</h1>";
	...
	"<form name='formulario'>
		<table align='center'>
			...
			<tr>
				...
				<td class=estilocelda2><input type='text' id='nombre' value='' border='1' size='40' maxlength='100'></td>
			</tr>
			<tr>
				<td align='center' colspan='2'>
					<input type='button' onclick=agregar_clientes(); id='registra' value='Agregar'>
				</td>
			</tr>
		</table>
	</form>";
