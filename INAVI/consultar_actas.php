<?php
	...
	if (isset($_GET['elim'])){
		$band = validar_fk_actas($bd_inavi,$_GET['selecc']);
		if ($band==0){
			$sql=eliminar_acta($bd_inavi,$_GET['selecc']);
			if ($sql==false)
			...
			$mensaje = "El acta no puede ser eliminada!!";
...
<form id="formulario" name="formulario" method="get">
   ...
   <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="center" class="Textos">TIPOS DE ACTAS</td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
    ...
    <tr align="center">
	  ...
	  <thead class="cabecera_c">
		...
		<?php
			...
			$sql = $sql." ORDER BY descripcion_actas"; // consulta completa
        ...
        <tr height="30" class="contenido">
          <td><?php echo $consulta['descripcion_actas'];?></td>
		  <td>
		  <a href="modificar_acta.php?rif=<?php echo $consulta['id_actas']; ?>&page=<?php echo $page;?>">
		  <img src="img/button_edit.png" border="0" width="13" height="13" title="Modificar Acta"></a>
		  | <a href="consultar_actas.php?elim=1&selecc=<?php echo $consulta['id_actas'];?>" onClick="if(!confirm('Confirma eliminar Entidad&#063;')) return false">
