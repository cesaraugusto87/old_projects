<?php
   ...
   if (isset($_POST['m1'])){
      ...
      $conexion = Conectarse();   
	  $sql2= "UPDATE pago SET enero = '" .$enero. "', febrero = '" .$febrero. "', marzo = '" .$marzo. "', abril = '" .$abril. "', mayo = '" .$mayo. "', junio = '" .$junio. "', julio = '" .$julio. "', agosto = '" .$agosto. "', septiembre = '" .$septiembre. "', octubre = '" .$octubre. "', noviembre = '" .$noviembre. "', diciembre = '" .$diciembre. "', tipo = '" .$tipo. "' WHERE ci_representante = '" .$ci_rep. "' ";
      ...
      if($registros2 > 0){		
         ...
         echo "window.location.href= 'DatosParticipantes.php'";
		 echo "</script>";
		 $band = 1;
		 exit; 
	  }else{
         ...
         if ($cedula != ""){
            ...
            $conexion = Conectarse();   
            $sql="select * from estudiantes where (ci_representante ='".$cedula."')"; 
            $resultado = mysql_query($sql, $conexion);
            $row_usuario = mysql_fetch_assoc($resultado);
	        $ifilas = mysql_affected_rows ($conexion);
            if($ifilas > 0 ){	
	           $sql2="select * from pago where (ci_representante ='".$cedula."')"; 
			   ...
			   <table width="554" border="1">
                 <tr>
                    <td colspan="4">
					   <div align="center">
					      <span class="Estilo16">
						     Datos Padre</span>					   </div>					</td>
                 </tr>
                 <tr>
                   <td width="50" align="right" valign="middle" class="Estilo7">Nombre Representante</td>
                   <td width="366" colspan="3" class="Estilo12"><label>
                     <input type="text" name="representante" value=<?php echo $row_usuario['representante'] ?> id="representante">
                   </label></td>
                 </tr>
                 <tr>
                   <td align="right" valign="middle" class="Estilo7">Ci Representante</td>
                   <td colspan="3" class="Estilo12"><label>
                     <input type="text" name="ci_rep" value=<?php echo $row_usuario['ci_representante'] ?> id="ci_rep">
                   </label></td>
                 </tr>
                 <tr>
                   <td align="right" valign="middle" class="Estilo7">Lugar de Trabajo</td>
                   <td colspan="3" class="Estilo12"><label>
                     <input type="text" name="lugar_trab" value=<?php echo $row_usuario['lugar_trab'] ?> id="lugar_trab">
                   </label></td>
                 </tr>
                 <tr>
                   <td align="right" valign="middle" class="Estilo7">PADRE AL DIA?</td>
                   <td colspan="3" class="Estilo12"><label>
                 ...
                 <tr>
                   <td colspan="4" align="right" valign="middle" class="Estilo7"><label>
                     <div align="center">
                 ...
                 <tr>
                    <td colspan="4" align="right" valign="middle" class="Estilo7">&nbsp;</td>
                 </tr>
              </table>
		   </td>
         </tr>
            ...
            <td height="30">
			   <table width="584" border="0">
                  <tr>
                     <td width="227">&nbsp;</td>
                     <td width="111">
				        <div align="center" class="boton"><a href="BuzonAdministrador.php">Regresar</a></div>
				     </td>
                     <td width="232">&nbsp;</td>
                  </tr>
               </table>
