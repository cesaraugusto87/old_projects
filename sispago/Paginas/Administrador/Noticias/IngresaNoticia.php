<?php
   if($_POST['Ingresar']){
      ...
      $conexion = Conectarse();
	  $sql="insert into noticias values('','".$titulo."','".$resumen."','".$noticia."','".$foto."','".$fecha."','".$status."')";	   
   ...
   <table width="447" border="1" align="center" background="../../../images/fondo.jpg">
     ...
     <tr>
       <td><table width="439" border="1">
         ...
         <tr>
           <td class="boton"><div align="right" class="Estilo7">IMAGEN</div></td>
           <td class="boton"><input name="CampoImagen" type=file class="Estilo12" id="CampoImagen" value="Examinar" size="40" maxlength="35" /></td>
         </tr>
